...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			...
			<a href="single.html">
				<img class="card-img-top img-fluid" src="/img/products/products-1.jpg" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			<!-- <div class="price">$200</div> -->
			<a href="single.html">
				<img class="card-img-top img-fluid" src="/img/products/products-2.jpg" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			<!-- <div class="price">$200</div> -->
			<a href="single.html">
				<img class="card-img-top img-fluid" src="/img/products/products-3.jpg" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
		    <h4 class="card-title"><a href="single.html">11inch Macbook Air</a></h4>
